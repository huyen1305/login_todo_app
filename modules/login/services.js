        ...
        ['Base64', '$http', '$cookieStore', '$rootScope', '$timeout',
            function (Base64, $http, $cookieStore, $rootScope, $timeout) {
                ...
                service.Login = function (username, password, callback) {
                    ...
                    //     $scope.profile = localStorage.getItem('profiles');
                    // }
                    // angular.forEach($scope.profile, function (p) {
                    //     $timeout(function(){
                    //         var response = { success: username === p.username && password === p.password };
                    //         if(!response.success) {
                    ...
                    $timeout(function(){
                        var response = { success: username === 'hey' && password === 'hey' };
                        if(!response.success) {
                            response.message = 'Username or password is incorrect';
                        }
                        callback(response);
